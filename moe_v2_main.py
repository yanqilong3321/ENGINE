...
def efficient_train_eval(train_loader, val_loader, test_loader, xs, model_list, prog_list, alpha_list, exit_list, optimizer, loss_fn,task_id,task_class_splits):
    ...
    for epoch in tqdm(range(config.epochs)):
        ...
        val_acc = efficient_eval_combined(val_loader, xs, model_list, prog_list, alpha_list, exit_list,task_id)
        test_acc = efficient_eval_combined(test_loader, xs, model_list, prog_list, alpha_list, exit_list,task_id)
...
def efficient_eval_combined(test_loader, xs, model_list, prog_list, alpha_list, exit_list, task_id, early_exit=True):
    correct = 0
    total_cnt = 0
    with torch.no_grad():
...
if __name__ == '__main__':
    ...
    for i, seed in enumerate(config.seeds):
        ...
        for task_id, task_data in enumerate(task_datasets):
            ...
            current_task_acc = efficient_eval_combined(test_loader, xs_list, model_list, prog_list, alpha_list, exit_list,task_id)
            ...
            for prev_task_id in range(task_id + 1):
                ...
                prev_task_acc = efficient_eval_combined(prev_test_loader, xs_list, model_list, prog_list, alpha_list, exit_list,task_id)
